...
//    }
    ...
    public void testSettingJobId() {
        assertTrue( test_job3.getId() - test_job2.getId() == 1);
    }
    ...
    public void testJobConstructorSetsAllFields() {
        ...
        assertSame("ACME", test_job1.getEmployer().getValue());
        assertSame("Desert", test_job1.getLocation().getValue());
        assertSame("Quality control", test_job1.getPositionType().getValue());
        assertSame("Persistence", test_job1.getCoreCompetency().getValue());
    }
...
//test_job1 = new Job(, new Employer("ACME"), new Location("Desert"), new PositionType("Quality control"), new CoreCompetency("Persistence"));